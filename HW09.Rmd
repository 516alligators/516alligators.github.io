...
Our research question focuses on whether tweets from TikTok's and Facebook's accounts differ in sentiments, length, or other notable dimensions. 
...
Second, we transform the datasets into tidytext format for sentiment analysis. The two main lexicons that we use are NRC and AFINN.  
