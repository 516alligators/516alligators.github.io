...
author: "A. Plumber, E. Lin, K. Nguyen, M. Aines, R. Karbowicz"
date: "4/25/2021"
...
writeLines(c(paste0("Facebook Mean Tweet Length: ", 
                  round(mean(fb_wordcounts$tweetLength), 2)), 
           paste0("TikTok Mean Tweet Length: ", 
                  round(mean(tiktok_wordcounts$tweetLength), 2))))

hist(tiktok_wordcounts$tweetLength, main = "TikTok - Histogram of Tweet Lengths", xlab = "character count")

hist(fb_wordcounts$tweetLength, main = "Facebook - Histogram of Tweet Lengths", xlab = "character count")
```
...
for_decisiontree <-
  both_users %>% dplyr::select(-1,-2,-3,-4)
