...
Finally, we train four different models to predict if a tweet was posted by either Facebook or TikTok. The inputs of these models are the length of the tweet, presence of pictures, sentiment (which includes anger, anticipation, disgust, negative, postive, trust, joy, surprise, fear and sadness), and positive/negative valence, estimated by averaging AFINN scores over each tweet.
